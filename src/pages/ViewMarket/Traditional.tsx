...
export default function ViewMarket(props: any) {
    ...
    const tokens = [data.spamPredictionMarket.spamToken, data.spamPredictionMarket.notSpamToken, data.spamPredictionMarket.community.token]
    return <>
        <Row>
            <PostContent>
            ...
            <YourBet>
                ...
                <span>
                    { fromWei(data.user.spamToken_balance) } SPAM : { fromWei(data.user.notSpamToken_balance) } NOT-SPAM</span>
            </YourBet>
        </Row>
