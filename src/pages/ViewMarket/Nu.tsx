    ...
    return <>
        <Row>
            ...
            <YourBet>
                ...
                <span>
                    <FormattedCurrencyAmount currencyAmount={CurrencyAmount.ether(data.user.spamToken_balance)}/> SPAM : <FormattedCurrencyAmount currencyAmount={CurrencyAmount.ether(data.user.notSpamToken_balance)}/> NOT-SPAM</span>
            </YourBet>
        </Row>
...
const SpamSelector = (props: any) => {
    ...
    async function onSelect(ev: any) {
        ...
        await market.buy('10000000000000')
    }
