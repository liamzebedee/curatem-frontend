        ...
        <>
            <Row>
                ...
                <YourBet>
                    ...
                    <span>
                        <FormattedCurrencyAmount currencyAmount={CurrencyAmount.ether(data.user.spamToken_balance)} />{' '}
                        SPAM :{' '}
                        <FormattedCurrencyAmount
                            currencyAmount={CurrencyAmount.ether(data.user.notSpamToken_balance)}
                        />{' '}
                        NOT-SPAM
                    </span>
                </YourBet>
